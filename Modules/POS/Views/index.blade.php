...
<div class="bg-white rounded-lg shadow p-6">
    ...
    <div class="grid grid-cols-3 gap-6" x-data="posApp()">
        <div class="col-span-2">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div @click="addToCart(<?php echo htmlspecialchars(json_encode($product)); ?>)" 
                     class="bg-gray-50 p-4 rounded-lg cursor-pointer hover:bg-gray-100 transition">
        ...
        <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <div class="space-y-2 mb-4" x-show="cart.length > 0">
                <template x-for="(item, index) in cart" :key="index">
                    <div class="flex justify-between items-center p-2 bg-white rounded">
                        <div>
                            <span x-text="item.name"></span>
                            <span class="text-sm text-gray-500" x-text="'x' + item.quantity"></span>
                        </div>
            ...
            <div class="mt-4 pt-4 border-t">
                ...
                <button @click="placeOrder()" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg">
                    Place Order
                </button>
            </div>
        </div>
